...
function loadStep(stepIndex) {
    ...
    if (gameState.parcours === 'moctezuma') {
        steps = moctezumaStepsData; // Pas encore de version simple pour Moctezuma
    } else {
        // Parcours Cortés : choisir selon la difficulté
    ...
    if (selectedDifficulty === 'simple' && stepIndex === 0) {
        ...
        messageDiv.innerHTML = '✨ <strong>Mode Simplifié activé</strong> - Textes plus courts et vocabulaire accessible (Version démo : 4 étapes)';
